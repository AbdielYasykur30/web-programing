...
<html>
<head>
	<title>Web Programing | Muhammad Abdiel</title>
			...
			<div class="form-group row">
				...
				<div class="col-sm-10">
					<select name="jurusan" class="form-control" required>
						...
						<option value="TEKNIK SIPIL" <?php if($data['jurusan'] == 'AKUNTASI'){ echo 'selected'; } ?>>AKUNTASI</option>
						<option value="PERTANIAN" <?php if($data['jurusan'] == 'FARMASI'){ echo 'selected'; } ?>>FARMASI</option>
						<option value="PERTANIAN" <?php if($data['jurusan'] == 'TEKNIK KOMPUTER'){ echo 'selected'; } ?>>TEKNIK KOMPUTER</option>
					</select>
				</div>
			</div>
			<div class="form-group row">
